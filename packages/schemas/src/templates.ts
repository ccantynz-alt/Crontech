...
export const TEMPLATES: Template[] = [
  ...
  // ── Accounting Vertical Templates ──────────────────────────────
  {
    id: "accounting-firm-landing",
    name: "Accounting Firm Landing Page",
    description: "Professional services landing page for accounting firms and CPAs.",
    category: "landing",
    preview: "/templates/accounting-firm.png",
    tags: ["accounting", "cpa", "firm", "professional"],
    difficulty: "beginner",
    estimatedTime: "3 minutes",
    componentTree: [
      hero(
        "Numbers You Can Trust. Advice You Can Use.",
        "Full-service accounting, tax, and advisory for growing businesses.",
      ...
      ),
      {
        ...
        props: { direction: "horizontal", gap: "md", align: "stretch", justify: "center" },
        children: [
          card("Tax Strategy", "Year-round planning, not just filing."),
          card("Bookkeeping", "Clean books delivered every month, on time."),
          card("Advisory", "Strategic CFO insight when you need it most."),
        ],
      },
    ],
  },
  {
    id: "accounting-cpa-portfolio",
    name: "CPA Portfolio",
    description: "Showcase your services, team, and credentials.",
    category: "portfolio",
    preview: "/templates/accounting-cpa.png",
    tags: ["accounting", "cpa", "portfolio", "team"],
    difficulty: "beginner",
    estimatedTime: "4 minutes",
    componentTree: [
      { component: "Text", props: { content: "Meet the Team", variant: "h1", weight: "bold", align: "center" } },
      {
        component: "Stack",
        props: { direction: "horizontal", gap: "md", align: "stretch", justify: "center" },
        children: [
          card("Sarah Chen, CPA", "20 years tax strategy. Stanford GSB."),
          card("Marcus Whitfield, EA", "Former IRS auditor. Audit defense expert."),
          card("Priya Anand, MBA", "Forensic accounting and litigation support."),
        ],
      },
    ],
  },
  {
    ...
    name: "Tax Services Page",
    description: "Tax services overview with embedded calculator.",
    category: "landing",
    preview: "/templates/accounting-tax.png",
    tags: ["tax", "calculator", "services"],
    difficulty: "intermediate",
    estimatedTime: "5 minutes",
    componentTree: [
      { component: "Text", props: { content: "Tax Services", variant: "h1", weight: "bold", align: "center" } },
      { component: "Text", props: { content: "From individual returns to multi-state corporate filings.", variant: "body", weight: "normal", align: "center" } },
      {
        component: "Card",
        props: { title: "Quick Tax Estimator", description: "Enter your income to get a ballpark estimate", padding: "lg" },
        children: [
          { component: "Input", props: { name: "income", type: "number", label: "Annual Income", placeholder: "100000", required: true, disabled: false } },
          { component: "Input", props: { name: "filingStatus", type: "text", label: "Filing Status", placeholder: "Single / Married", required: true, disabled: false } },
          { component: "Button", props: { label: "Calculate", variant: "primary", size: "lg", disabled: false, loading: false } },
        ],
      },
    ],
  },
  {
    id: "accounting-client-portal",
    name: "Client Portal Dashboard",
    description: "Secure client-facing dashboard with documents, invoices, and messages.",
    category: "app",
    preview: "/templates/accounting-portal.png",
    tags: ["portal", "client", "dashboard"],
    difficulty: "intermediate",
    estimatedTime: "5 minutes",
    componentTree: [
      { component: "Text", props: { content: "Client Portal", variant: "h1", weight: "bold", align: "left" } },
      {
        component: "Tabs",
        props: {
          items: [
  ...
  {
    id: "accounting-invoice-template",
    name: "Invoice Template",
    description: "Clean, professional invoice ready to send to clients.",
    category: "app",
    preview: "/templates/accounting-invoice.png",
    tags: ["invoice", "billing", "template"],
    difficulty: "beginner",
    estimatedTime: "2 minutes",
    componentTree: [
      { component: "Text", props: { content: "Invoice", variant: "h1", weight: "bold", align: "left" } },
      { component: "Text", props: { content: "Bill To: Client Name", variant: "body", weight: "normal", align: "left" } },
      { component: "Input", props: { name: "invoiceNumber", type: "text", label: "Invoice Number", placeholder: "INV-001", required: true, disabled: false } },
      { component: "Input", props: { name: "amount", type: "number", label: "Amount Due", placeholder: "0.00", required: true, disabled: false } },
      { component: "Button", props: { label: "Download PDF", variant: "primary", size: "lg", disabled: false, loading: false } },
    ],
  },
  {
    id: "accounting-financial-report",
    name: "Financial Report Template",
    description: "Profit & Loss summary ready for board presentation.",
    category: "app",
    preview: "/templates/accounting-report.png",
    tags: ["report", "financial", "p&l"],
    difficulty: "intermediate",
    estimatedTime: "3 minutes",
    componentTree: [
      { component: "Text", props: { content: "Profit & Loss Statement", variant: "h1", weight: "bold", align: "center" } },
      {
        component: "Stack",
        props: { direction: "vertical", gap: "md", align: "stretch", justify: "start" },
        children: [
          card("Revenue", "Total income from all sources"),
          card("Expenses", "Operating costs and overhead"),
          card("Net Income", "Bottom line after all deductions"),
        ],
      },
    ],
  },
