      ...
      <Stack direction="vertical" gap="lg" class="page-padded legal-page">
              ...
              <table class="w-full text-sm text-left border-collapse">
                <thead>
                  <tr class="border-b border-slate-200">
                    <th class="py-2 pr-4 font-semibold text-slate-900">Tier</th>
                    <th class="py-2 pr-4 font-semibold text-slate-900">Monthly Uptime</th>
                    <th class="py-2 pr-4 font-semibold text-slate-900">Max Monthly Downtime</th>
                  </tr>
                </thead>
        ...
        <Card padding="md">
          <Stack direction="vertical" gap="sm">
            ...
            <div class="bg-slate-50 rounded-lg p-4 font-mono text-sm text-slate-800">
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-sm text-left border-collapse">
                <thead>
                  <tr class="border-b border-slate-200">
                    <th class="py-2 pr-4 font-semibold text-slate-900">Monthly Uptime %</th>
                    <th class="py-2 pr-4 font-semibold text-slate-900">Service Credit</th>
                  </tr>
                </thead>
                <tbody class="text-slate-700">
                  <tr class="border-b border-slate-100">
          ...
          <Stack direction="vertical" gap="sm">
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-sm text-left border-collapse">
                <thead>
                  <tr class="border-b border-slate-200">
                    <th class="py-2 pr-4 font-semibold text-slate-900">Severity</th>
                    <th class="py-2 pr-4 font-semibold text-slate-900">Enterprise</th>
                    <th class="py-2 pr-4 font-semibold text-slate-900">Team</th>
                    <th class="py-2 font-semibold text-slate-900">Pro</th>
                  </tr>
                </thead>
                <tbody class="text-slate-700">
                  <tr class="border-b border-slate-100">
                    <td class="py-2 pr-4 font-semibold text-slate-800">Critical</td>
                    <td class="py-2 pr-4">1 hour (24/7)</td>
                    <td class="py-2 pr-4">4 hours</td>
                    <td class="py-2">24 hours</td>
                  </tr>
                  <tr class="border-b border-slate-100">
                    <td class="py-2 pr-4 font-semibold text-slate-800">High</td>
                    <td class="py-2 pr-4">4 hours</td>
                    <td class="py-2 pr-4">8 hours</td>
                    <td class="py-2">48 hours</td>
                  </tr>
                  <tr>
                    <td class="py-2 pr-4 font-semibold text-slate-800">Medium</td>
        ...
        <Card padding="md">
          <Stack direction="vertical" gap="sm">
            ...
            <div class="bg-slate-50 rounded-lg p-4">
              <Text variant="body" weight="semibold" class="text-slate-900">
